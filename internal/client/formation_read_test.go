...
func TestPeerSidState(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"gone on another machine", FormationPeer{Alias: "a", SessionID: "dead-dead-dead", Machine: "server"}, SidUnchecked},
		{"present beats a foreign machine tag", FormationPeer{Alias: "a", SessionID: live, Machine: "server"}, SidPresent},
	} {
