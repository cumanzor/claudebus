...
const designExample = `{
  ...
  "drift_anchors": { "git_head": "e844702", "notes": "apply verifies and reports; the tracker is re-queried, never trusted from the file" },
  "payload": {
    "work_state": "tracker cbus-vj9",
    "blockers": "tracker cbus-vj9 notes",
