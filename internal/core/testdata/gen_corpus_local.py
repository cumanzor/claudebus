...
CASES = [
    ("ch/orch", "ch/laptop", TS, "presence", "join", "joined ch as orch"),
    ("ch/orch", "ch/laptop", TS, "presence", "leave", "left ch"),
    ("ch/orch", "ch/laptop", TS, "presence", "departed", "departed (listener gone)"),
    ("ch/orch", "ch/laptop", TS, "presence", "rename", "renamed orch -> lead"),
    ("ch/orch", "ch/laptop", TS, "presence", "join", "line1\nline2\nline3"),          # multi-line body under a kind header
    ("ch/orch", "ch/laptop", TS, "presence", "join", "joined 🎉 " + "你" * 200),        # multibyte wrap under a kind header
    ("ch/orch", "ch/laptop", TS, "presence", "join", "x" * 1000),                     # long body wraps under a kind header
