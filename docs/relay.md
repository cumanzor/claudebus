...
```sh
cbus connect dev@nuc mbp --json
cbus list dev@nuc                              # one roster check after joining
cbus connection status dev@nuc/mbp --json       # on-demand receipt inspection
cbus connection disconnect dev@nuc/mbp         # stop delivery, retain local history
```
