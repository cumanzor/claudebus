...
```sh
cbus connect b32-terms-updates advisor-main --json
cbus connection status b32-terms-updates/advisor-main --json
```
...
cbus daemon restart
cbus connection disconnect b32-terms-updates/advisor-main
```
...
```sh
cbus connection reconcile b32-terms-updates/advisor-main --json
```
...
```sh
cbus connection abandon b32-terms-updates/advisor-main \
...
```sh
cbus connect dev@nuc advisor --json
cbus connection status dev@nuc/advisor --json
cbus send dev@nuc/worker 'Please review the change'
```
