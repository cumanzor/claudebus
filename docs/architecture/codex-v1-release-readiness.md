...
**Verdict: Codex CLI v1 is released; v0.12.2 was installed on Mac and NUC.**
...
- Normal selfupdate installed the matching assets and the daemons restarted on
  ...
  Mac: `/tmp/cbus-v0122-install-mac.json` (107 checks); NUC:
  `/tmp/cbus-v0122-install-nuc.json` (59 checks). Saved registrations are not a
