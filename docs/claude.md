...
For cross-machine delivery, use `cbus connect demo@nuc worker --json` and retain
`@nuc` in later commands. Relay authentication and a matching acknowledged-delivery
